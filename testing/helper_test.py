...
class TestStart:
    ...
    def test_host_mode_network_id_with_host_address(self):
        ...
        with run_helper(
            ...
            self.check_interface(h.interface)
            self.check_network_id_host_address(h)
    ...
    def check_network_id_host_address(self, h):
        assert h.interface[VMNET_START_ADDRESS] == h.host_ip_address
        assert h.interface[VMNET_SUBNET_MASK] == h.host_subnet_mask
